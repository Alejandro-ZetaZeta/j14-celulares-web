  ...
  return (
    <article className="catalog-tile">
      <Link
        ...
        className="block rounded-[var(--radius-md)] focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent)] focus-visible:ring-offset-2"
      ...
      <div className="catalog-tile-price-row">
        <Link
          href={`/catalogo/${product.id}`}
          className="min-w-0 block rounded-[var(--radius-sm)] focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent)] focus-visible:ring-offset-2"
        ...
        >
          ...
          <p className="text-[18px] font-semibold tracking-[-0.02em] text-[var(--text-primary)]">${price.toLocaleString("en-US")}</p>
        </Link>
